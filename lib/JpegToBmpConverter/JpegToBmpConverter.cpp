      ...
      for (int blockY = 0; blockY < mcuPixelHeight; blockY++) {
        for (int blockX = 0; blockX < mcuPixelWidth; blockX++) {
          ...
          if (imageInfo.m_comps == 1) {
            ...
            // Balanced grayscale: give blue more weight than standard luminance
            // [COMMENTED OUT] Standard BT.601: gray = (r * 30 + g * 59 + b * 11) / 100;
            // Balanced: r*25 + g*50 + b*25 (blue gets equal weight to red)
